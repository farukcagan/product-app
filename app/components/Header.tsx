            ...
            <div className="flex items-center gap-4">
                ...
                <div className="relative border-l pl-6" ref={dropdownRef}>
                    <Button
                        ...
                        className="!flex !items-center !gap-3 !group !focus:outline-none !transition-all !duration-300 !p-0 hover:!bg-transparent h-auto w-auto"
                    >
                        ...
                        <div className="hidden md:flex flex-col items-start mr-2">
                            ...
                            <span className="text-[10px] text-brand-text-muted mt-0.5 uppercase tracking-wider font-bold">{CONTENT.header.role}</span>
                        </div>
                        <ChevronSvg
                    ...
                    <div className={`absolute right-0 mt-3 w-56 origin-top-right rounded-2xl bg-white p-2 shadow-[0_20px_50px_rgba(0,0,0,0.15)] border border-gray-100 transition-all duration-300 z-50 ${isDropdownOpen ? 'opacity-100 translate-y-0 visible' : 'opacity-0 -translate-y-4 invisible'}`}>
                        <div className="px-4 py-3 border-b border-gray-50 mb-1">
                            <p className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-1">{CONTENT.header.accountLabel}</p>
                        ...
                        <Button
                            ...
                            className="!flex !w-full !items-center !gap-3 !rounded-xl !px-4 !py-2.5 !text-sm !font-medium !text-gray-600 hover:!bg-gray-50 hover:!text-brand-primary !transition-all !justify-start !h-auto !min-h-0"
                        >
                            <div className="h-2 w-2 rounded-full bg-brand-primary"></div>
                            {CONTENT.header.profileInfo}
                        </Button>
                        ...
                        <Button
                            ...
                            className="!flex !w-full !items-center !gap-3 !rounded-xl !px-4 !py-2.5 !text-sm !font-bold !text-red-500 hover:!bg-red-50 !transition-all !justify-start !h-auto !min-h-0"
                        >
